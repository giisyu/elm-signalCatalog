      ...
      return function () {
         ...
         {case "_Tuple2":
            return function () {
                 ...
                 defaultText(_v7._0));
                 var foverEle = A2($Graphics$Element.color,
                 $Color.blue,
                 ele);
                 var downEle = A2($Graphics$Element.color,
                 $Color.gray,
                 ele);
